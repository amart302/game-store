    ...
    <main v-if="currentProduct.name">
        ...
        <div class="product-container">
          ...
          <div class="product-other">
            ...
            <div class="product-prices">
              ...
              <div class="product-old-price" v-if="currentProduct.discounted">{{ currentProduct.original_price }} {{
                currentProduct.currency }}</div>
            </div>
      ...
      <div class="product-ostas">
        <div class="product-ostas-title">
          ...
          <div class="product-osta" @click="activeTab = 'requirements'">
            <div :class="{ 'product-osta-center': true, active: activeTab === 'requirements' }">Системные требования
            </div>
          </div>
      ...
      <div class="vam-budet-interesno">
        ...
        <div class="vam-budet-interesno-cont">
          <ProductCard v-for="ad in ads.slice(0, 4)" :key="ad.id" :game="ad" @favourites-updated="$forceUpdate()"
