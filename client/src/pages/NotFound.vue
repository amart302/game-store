<template>
    <div class="error-container">
        ...
        <p class="error-text">Ой! Кажется, мы заблудились в цифровом космосе</p>
    </div>
</template>
...
.error-container {
    ...
    gap: 100px;
    align-items: center;
    background: linear-gradient(135deg, #111111 0%, #1e1e1f 100%);
    overflow: hidden;
}
...
.sun {
    ...
    width: 50px;
    height: 50px;
    background: radial-gradient(circle, #ffcb4c, #ff7f32);
    border-radius: 50%;
    transform: translate(-50%, -50%);
    box-shadow: 0 0 50px 20px #ffcb4c;
    /* Уменьшил тень пропорционально */
}
...
.planet {
    ...
    border-radius: 50%;
    transform: translate(-50%, -50%);
    box-shadow: 0 0 8px 1px rgba(52, 152, 219, 0.7);
    /* Чуть уменьшил тень */
}

/* Уменьшил размеры орбит пропорционально */
.orbit1 {
    width: 80px;
    height: 80px;
...
.orbit5 {
    width: 260px;
    height: 260px;
    animation: orbit5 50s linear infinite;
}
...
.orbit7 {
    width: 360px;
    height: 360px;
    animation: orbit7 70s linear infinite;
}
...
/* Уменьшил размеры планет пропорционально */
.planet1 {
    background: #ff6b6b;
    width: 6px;
    height: 6px;
...
.moon {
    ...
    left: 100%;
    width: 3px;
    /* Уменьшил луну с 5px до 3px */
    height: 3px;
    background: #95a5a6;
    border-radius: 50%;
    transform: translate(-50%, -50%);
    box-shadow: 0 0 4px 1px rgba(149, 165, 166, 0.8);
